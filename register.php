  ...
  <div class="signInContainer">
    <div class="column">
      ...
      <form method="POST">
        ...
        <input type="text" name="lastName" placeholder="Last name" value="<?php getInputValue("lasrName"); ?>" required>
      ...
      <a href="login.php" class="signInMessage">Already have a Lydix account? Sign in here!</a>
    </div>
  </div>
